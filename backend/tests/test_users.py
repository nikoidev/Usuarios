...
class TestGetUsers:
    ...
    def test_get_users_as_admin(self, client: TestClient, admin_headers: dict, test_regular_user: User):
...
class TestDeleteUser:
    ...
    def test_delete_user_unauthorized(self, client: TestClient, user_headers: dict, test_admin_user: User):
