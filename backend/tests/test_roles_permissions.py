...
class TestGetRoles:
    ...
    def test_get_roles_success(self, client: TestClient, admin_headers: dict, test_admin_role: Role):
...
class TestGetRole:
    ...
    def test_get_role_by_id(self, client: TestClient, admin_headers: dict, test_admin_role: Role):
        ...
        response = client.get(
            f"/api/roles/{test_admin_role.id}",
            headers=admin_headers
        )
...
class TestGetPermissions:
    ...
    def test_get_permissions_success(self, client: TestClient, admin_headers: dict, test_permissions: list[Permission]):
    ...
    def test_get_permissions_filter_by_resource(self, client: TestClient, admin_headers: dict):
        ...
        response = client.get(
            "/api/permissions/?resource=users",
            headers=admin_headers
        )
