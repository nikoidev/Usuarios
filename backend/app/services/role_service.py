...
class RoleService:
    ...
    def get_roles(
        ...
        if search:
            ...
            query = query.filter(
                or_(Role.name.ilike(search_filter), Role.description.ilike(search_filter))
            )
    ...
    def create_role(db: Session, role: RoleCreate) -> Role:
        db_role = Role(name=role.name, description=role.description, is_active=role.is_active)
